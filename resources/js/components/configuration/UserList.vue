                ...
                >
                    ...
                    <template slot="action" slot-scope="data">
                        <div class="btn-group btn-group-sm" role="group" aria-label="Small button group">
                            ...
                            <button type="button" class="btn btn-warning" @click="openModal('tab_4', data.item)">Edit</button>
                        </div>
                    </template>
                </b-table>
            </b-col>
...
<script>
    export default {
        ...
        created() {
            Event.$on('configuration-user-list', (configuration) => {
                this.users = configuration;
