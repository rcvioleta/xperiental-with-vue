        ...
        <b-row>
            <b-col>
                ...
                <template slot="action" slot-scope="data">
                    <b-link @click="editForm($event.target, data.item.name, data.item.year_attended, data.item.notes, data.item.id)" class="table-button btn-warning btn-sm waves-effect waves-light">Edit <i class="fa fa-pencil"></i></b-link>
                </template>
            </b-table>
        </b-col>
    </b-row>
