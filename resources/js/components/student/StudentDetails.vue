    ...
    export default {
        ...
        created() {
            Event.$on('studentmanagement-edit', (studentmanagement) => {
                this.studentData = studentmanagement.student;
                this.url = studentmanagement.student.image;
            });
        },
        methods: {
            updateStudent(e) { 
                ...
                axios.post('/admin/studentmanagement/update/'+ this.studentData.id, data)
                .then(response => {
                    swal("Success!", 
                        "Successfully updated Student " + this.studentData.first_name + ' ' + this.studentData.last_name + ' with ID # ' + this.studentData.id_num, 
                        "success")
                    .then((value) => {
