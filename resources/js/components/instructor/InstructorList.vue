        ...
        <b-row>
            <b-col>
                ...
                <template slot="action" slot-scope="data">
                    <a :href="'/admin/instructor/' + data.item.id + '/edit'" class="btn btn-sm btn-warning pull-right waves-effect waves-light btable-button">
    ...
    export default {
        ...
        data() {
            return {
                ...
                instructorData: this.instructors,
                totalRows: this.instructors.length,
                filter: null,
                fields: [
