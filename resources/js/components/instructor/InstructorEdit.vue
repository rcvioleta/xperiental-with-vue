                ...
                <b-card>
                    <b-form @submit="updateEmployee">
                        ...
                        <b-row class="mt-5 mb-3">
                            <b-col class="mt-5">
                                <button type="submit" class="btn btn-primary pull-right">Update Employee <i class="ml-2 batch-icon batch-icon-stiffy"></i></button>
                            </b-col>
                        </b-row>
                    </b-form>
                </b-card>
...
<script>
    export default {
        ...
        created() {
            axios.get('/admin/instructor/edit/' + this.id)
            .then(response => {
        ...
        methods: {
            updateEmployee(e) {
                ...
                axios.post('/admin/instructor/update/' + this.employeeData.id, data)
                .then(response => {
                    swal("Success!", 
                        "Successfully updated Employee " + this.employeeData.first_name + ' ' + this.employeeData.last_name + ' with ID # ' + this.employeeData.id_num, 
                        "success")
                    .then((value) => {
